...
st.caption('Works for all positions for players playing in any one of Europe\'s Top 5 Leagues - Premier League, La Liga, Seria A, Ligue 1 and Bundesliga. Updated for the 2022/23 Season.')
...
#         st.write(player,"plays at position:",pos)
    ...
    if (pos == 'Right-Back') or (pos == 'Left-Back') or (pos == 'Left WingBack') or (pos == 'Right WingBack'):
        ...
        df = df[['Player','Squad','Age','xA per KP p90 (passing_p90)','KP p90 per 50 passes (passing_p90)','Successful Dribbles_p90 (possession_p90)',
                 'Attempted Dribbles_p90 (possession_p90)','Passes into Penalty Area_p90 (passing_p90)','Passes into Final 1/3_p90 (passing_p90)',
                 ...
                 'Prog Passes_p90 per 50 passes (passing_p90)','Off_p90 (misc_p90)','Average Shot Distance (shooting_p90)', 'Att Pen_p90 (possession_p90)']]
        ...
        df = df[['Player','Squad','Age','Successful Dribbles_p90 (possession_p90)', 'Sh_p90 (shooting_p90)',
                 ...
                 'Passes into Penalty Area_p90 (passing_p90)','Carries into Penalty Area_p90 (possession_p90)', 'Att Pen_p90 (possession_p90)',
        ...
        df = df[['Player','Squad','Age','xA per KP p90 (passing_p90)','Passes into Penalty Area_p90 (passing_p90)',
                 ...
                 'Average Shot Distance (shooting_p90)', 'xAG_p90 (passing_p90)', 'xA_p90 (passing_p90)', 'Att Pen_p90 (possession_p90)',
...
st.caption('Feel free to reach out to me on Twitter via DMs if you have any questions or if you face any issues with the app: https://twitter.com/Anuraag027')
